...
-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('ANGENOMMEN', 'IN_BEARBEITUNG', 'WARTET_AUF_KUNDE', 'ABGESCHLOSSEN', 'STORNIERT');

-- CreateEnum
CREATE TYPE "TicketStatus" AS ENUM ('OFFEN', 'IN_BEARBEITUNG', 'WARTET_AUF_KUNDE', 'GESCHLOSSEN');
...
CREATE TABLE "orders" (
    ...
    "title" TEXT NOT NULL,
    "description" TEXT,
    "status" "OrderStatus" NOT NULL DEFAULT 'ANGENOMMEN',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
